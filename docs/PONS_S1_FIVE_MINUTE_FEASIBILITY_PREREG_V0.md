...
- At least 80% of the C0-admissible, primary-observed subset must have a complete conservative full-path cost envelope. Missing costs are `UNKNOWN`.
- At least 90% of observed C0 entries must have an executable fixed-horizon exit *or a separately validated recovery path*; an unavailable V4 proof counts as unknown and blocks this gate.
